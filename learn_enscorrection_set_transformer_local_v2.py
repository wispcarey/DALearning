...
def train_model(epoch, loader, model_list, optimizer, scheduler, args, H_info=None):
    model, local_model, st_model = model_list
    ...
    for batch_ind, batch_v in enumerate(loader):
        ...
        for i in range(end_ind):
            ...
            ens_nn_output = st_model(torch.cat([ens_v_f, hv], dim=-1))
...
if __name__ == "__main__":
    ...
    folder_name += f"{args.dataset}_{args.sigma_y}_{args.N}_{args.train_steps}_{args.train_traj_num}_EnST{suffix}_{args.loss_type}_v2"
